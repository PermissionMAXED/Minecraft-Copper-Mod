...
FEATURE_DOC = [
    ...
    "(loot tables under {@code loot_table/entities/}), natural spawns in the three Inferno",
    "biomes, and a drop-conversion recipe under {@code recipe/ashhorde/}.",
    "",
...
def feature_src() -> str:
    ...
    out += ["",
            ...
            "\t\t// addSpawn signature verified via javap: (Predicate<BiomeSelectionContext>,",
