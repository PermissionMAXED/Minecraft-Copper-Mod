...
DE_NAMES = {
    ...
    "cinder_crystal_block": "Zunderkristallblock",
...
HANDBOOK_TEXTS = [
    ...
    ("patch_cinder_fern", "cinder_fern",
     ...
     "Zunderfarne entrollen sich auf Zunderstein, Glutboden und Asche im ganzen Inferno."),
    ...
    ("patch_ash_bramble", "ash_bramble",
     ...
     "Aschendornb\u00fcsche wuchern \u00fcber Aschenverwehungen und Zunderkies der \u00d6de."),
    ...
    ("patch_charred_shrub", "charred_shrub",
     ...
     "Verkohlte Str\u00e4ucher: totes, glutgesprenkeltes Buschwerk, das sich aus der Zunder\u00f6de krallt."),
    ...
    ("garden_wastes_mix", "sear_sprigs",
     ...
     "W\u00fcsteng\u00e4rten: gemischte Best\u00e4nde aus Sengzweiglein, Aschendornb\u00fcschen, Zunderfarnen und verkohlten Str\u00e4uchern."),
    ...
    ("garden_slag_mix", "slag_thistle",
     ...
     "Schlackeng\u00e4rten: karge Beete aus Schlackendisteln, Ru\u00dfbovisten und Zunderfarnen auf den Delta-Ebenen."),
    ...
    ("cinder_crystal_cluster", "cinder_crystal_block",
     ...
     "Zunderkristall-Ansammlungen (Licht 9) ragen in dichten, funkelnden Klumpen aus dem Boden der \u00d6de."),
