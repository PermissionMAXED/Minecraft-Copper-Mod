...
MOBS = [
    ...
    ("ember_grazer", "EmberGrazerEntity", "cow", "Ember Grazer", "Glutgraser",
     ...
     "ein friedliches Rind, das schwelende B\u00fcschel in der Zunder\u00f6de, im Gluthain und am Schlackenmeer abweidet."),
    ...
    ("cinder_aurochs", "CinderAurochsEntity", "cow", "Cinder Aurochs", "Zunder-Auerochse",
     ...
     "ein urt\u00fcmlicher Wildochse mit zunderverkrusteten H\u00f6rnern, der gr\u00f6\u00dfte Graser des Infernos."),
    ...
    ("cinder_rooster", "CinderRoosterEntity", "chicken", "Cinder Rooster", "Zunderhahn",
     ...
     "ein stolzierender Hahn mit zunderrotem Gefieder, der flink \u00fcber die \u00d6de huscht."),
    ...
    ("ash_fowl", "AshFowlEntity", "chicken", "Ash Fowl", "Aschenhuhn",
     ...
     "ein blasses, staubiges Huhn, das in den Aschenwehen der Zunder\u00f6de kaum auff\u00e4llt."),
    ...
    ("magma_hog", "MagmaHogEntity", "pig", "Magma Hog", "Magmakeiler",
     ...
     "ein stämmiger Keiler, der in warmen Zunderbetten nach vergrabener Glut w\u00fchlt."),
    ...
    ("cinder_boar", "CinderBoarEntity", "pig", "Cinder Boar", "Zundereber",
    ...
    ("cinder_ram", "CinderRamEntity", "sheep", "Cinder Ram", "Zunderwidder",
     ...
     "ein dickk\u00f6pfiger Widder mit zunderdunklen Locken, der den Rand der Herde bewacht."),
