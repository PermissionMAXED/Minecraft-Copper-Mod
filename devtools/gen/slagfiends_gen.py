...
MOBS = [
    ...
    Mob("cinder_reaper", "wskel", "Cinder Reaper", "Zunderschnitter",
        "a swift, scythe-armed skeletal reaper",
        "ein flinker, sensenbewehrter Skelett-Schnitter",
        ("reaper_cinder", "Reaper Cinder", "Schnitter-Zunder", 0.0, 2.0,
    ...
    Mob("cinderhide_boar", "hoglin", "Cinderhide Boar", "Zunderfell-Keiler",
        "a fast, cinder-pelted boar",
        "ein schneller Keiler mit Zunderfell",
        ("cinderhide_scrap", "Cinderhide Scrap", "Zunderfell-Fetzen", 0.0, 2.0,
    ...
    # ----------------------------- PiglinEntity based -----------------------------
    Mob("cinder_piglin", "piglin", "Cinder Piglin", "Zunderpiglin",
        "a cinder-dusted piglin warrior",
        "ein zunderbest\u00e4ubter Piglin-Krieger",
        ("cinder_tooth", "Cinder Tooth", "Zunderzahn", 0.0, 2.0,
    ...
    Mob("slagforged_piglin", "piglin", "Slagforged Piglin", "Schlackengeschmiedeter Piglin",
    ...
    Mob("emberclad_piglin", "piglin", "Emberclad Piglin", "Glutgepanzerter Piglin",
        "a piglin armored in glowing ember shards",
        "ein in gl\u00fchende Glutsplitter gepanzerter Piglin",
    ...
    Mob("cinder_shade", "enderman", "Cinder Shade", "Zunderschatten",
        "a flickering shade of cinder and smoke",
        "ein flackernder Schatten aus Zunder und Rauch",
    ...
    Mob("ashen_zombie_piglin", "zpiglin", "Ashen Zombie Piglin", "Aschen-Zombiepiglin",
        ...
        "ein zombifizierter Piglin, grau gebleicht vom Aschefall",
    ...
    Mob("slagrot_piglin", "zpiglin", "Slagrot Piglin", "Schlackenmoder-Piglin",
        ...
        "ein modernder Piglin, verwachsen mit erkaltender Schlacke",
    ...
    Mob("cinderbound_piglin", "zpiglin", "Cinderbound Piglin", "Zundergebundener Piglin",
        "a shackled piglin bound in cinder-caked irons",
        "ein gefesselter Piglin in zunderverkrusteten Eisen",
        ("cinderbound_shackle", "Cinderbound Shackle", "Zunderfessel", 0.0, 1.0,
...
def build_handbook():
    ...
    for mob in MOBS:
        entries.append((
            ...
            f"{mob.de} - {mob.flavor_de}, heimisch in der Zunder\u00f6de, im Gluthain "
