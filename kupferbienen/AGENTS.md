...
- Startup marker to grep for: `[KUPFERBIENEN] Registered oxidation brewing chain (5 item recipes)`. Recipe check: the server should log `Loaded 1467 recipes` (vanilla 1461 + this mod's 6 crafting recipes) and `Loaded 1584 advancements` (vanilla 1574 + this mod's 6 recipe-unlock + 4 chain advancements).
