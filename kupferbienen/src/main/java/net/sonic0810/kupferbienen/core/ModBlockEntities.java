...
public final class ModBlockEntities {
	...
	/**
	 * Registers a block entity type under {@code kupferbienen:<path>} for the given blocks.
	 */
	public static <T extends BlockEntity> BlockEntityType<T> register(String path, FabricBlockEntityTypeBuilder.Factory<? extends T> factory, Block... blocks) {
		...
		return Registry.register(Registries.BLOCK_ENTITY_TYPE, Kupferbienen.id(path), type);
	}
}
