...
public final class ModEntities {
	...
	/**
	 * Registers an entity type under {@code kupferbienen:<path>}. The builder is built with the
	...
	public static <T extends Entity> EntityType<T> register(String path, EntityType.Builder<T> builder) {
		RegistryKey<EntityType<?>> key = RegistryKey.of(RegistryKeys.ENTITY_TYPE, Kupferbienen.id(path));
