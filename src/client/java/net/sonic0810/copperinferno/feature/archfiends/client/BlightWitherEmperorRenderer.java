...
/**
 * Renderer for the "Blight Wither Emperor" archfiend boss: the vanilla WitherSkeletonEntityRenderer
 ...
 * src/client/resources/assets/copper_inferno/textures/entity/blight_wither_emperor.png).
 ...
 */
public class BlightWitherEmperorRenderer extends WitherSkeletonEntityRenderer {
	private static final Identifier TEXTURE =
			Identifier.of("copper_inferno", "textures/entity/blight_wither_emperor.png");

	public BlightWitherEmperorRenderer(EntityRendererFactory.Context context) {
		super(context);
	}
