...
/**
 * Renderer for the "Molten Colossus" calamity boss: the vanilla IronGolemEntityRenderer
 ...
 * src/client/resources/assets/copper_inferno/textures/entity/molten_colossus.png).
 ...
 */
public class MoltenColossusRenderer extends IronGolemEntityRenderer {
	private static final Identifier TEXTURE =
			Identifier.of("copper_inferno", "textures/entity/molten_colossus.png");

	public MoltenColossusRenderer(EntityRendererFactory.Context context) {
		super(context);
	}
