...
/**
 * Renderer for the "Pyre Tyrant" calamity boss: the vanilla BlazeEntityRenderer
 ...
 * src/client/resources/assets/copper_inferno/textures/entity/pyre_tyrant.png).
 ...
 */
public class PyreTyrantRenderer extends BlazeEntityRenderer {
	private static final Identifier TEXTURE =
			Identifier.of("copper_inferno", "textures/entity/pyre_tyrant.png");

	public PyreTyrantRenderer(EntityRendererFactory.Context context) {
		super(context);
	}
