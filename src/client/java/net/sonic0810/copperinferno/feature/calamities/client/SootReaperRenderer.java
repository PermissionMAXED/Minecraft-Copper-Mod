...
/**
 * Renderer for the "Soot Reaper" calamity boss: the vanilla WitherSkeletonEntityRenderer
 ...
 * src/client/resources/assets/copper_inferno/textures/entity/soot_reaper.png).
 ...
 */
public class SootReaperRenderer extends WitherSkeletonEntityRenderer {
	private static final Identifier TEXTURE =
			Identifier.of("copper_inferno", "textures/entity/soot_reaper.png");

	public SootReaperRenderer(EntityRendererFactory.Context context) {
		super(context);
	}
