 ...
 * {@code loot_table/entities/cinder_silverfish.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class CinderSilverfishEntity extends SilverfishEntity {
	public CinderSilverfishEntity(EntityType<? extends SilverfishEntity> type, World world) {
		super(type, world);
	}
