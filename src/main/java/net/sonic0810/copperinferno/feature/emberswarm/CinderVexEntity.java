 ...
 * {@code loot_table/entities/cinder_vex.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class CinderVexEntity extends VexEntity {
	public CinderVexEntity(EntityType<? extends VexEntity> type, World world) {
		super(type, world);
	}
}
