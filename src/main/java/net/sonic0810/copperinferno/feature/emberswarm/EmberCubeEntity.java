 ...
 * {@code loot_table/entities/ember_cube.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class EmberCubeEntity extends MagmaCubeEntity {
	public EmberCubeEntity(EntityType<? extends MagmaCubeEntity> type, World world) {
		super(type, world);
	}
}
