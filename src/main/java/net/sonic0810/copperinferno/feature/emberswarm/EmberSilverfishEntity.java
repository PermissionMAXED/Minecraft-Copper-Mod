 ...
 * {@code loot_table/entities/ember_silverfish.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class EmberSilverfishEntity extends SilverfishEntity {
	public EmberSilverfishEntity(EntityType<? extends SilverfishEntity> type, World world) {
		super(type, world);
	}
