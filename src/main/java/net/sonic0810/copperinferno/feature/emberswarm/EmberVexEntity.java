 ...
 * {@code loot_table/entities/ember_vex.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class EmberVexEntity extends VexEntity {
	public EmberVexEntity(EntityType<? extends VexEntity> type, World world) {
		super(type, world);
	}
}
