 ...
 * {@code loot_table/entities/flame_vex.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class FlameVexEntity extends VexEntity {
	public FlameVexEntity(EntityType<? extends VexEntity> type, World world) {
		super(type, world);
	}
}
