 ...
 * {@code loot_table/entities/molten_cube.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class MoltenCubeEntity extends MagmaCubeEntity {
	public MoltenCubeEntity(EntityType<? extends MagmaCubeEntity> type, World world) {
		super(type, world);
	}
}
