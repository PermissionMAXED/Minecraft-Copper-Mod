 ...
 * {@code loot_table/entities/pyroclast_cube.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class PyroclastCubeEntity extends MagmaCubeEntity {
	public PyroclastCubeEntity(EntityType<? extends MagmaCubeEntity> type, World world) {
		super(type, world);
	}
}
