 ...
 * {@code loot_table/entities/scoria_cube.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class ScoriaCubeEntity extends MagmaCubeEntity {
	public ScoriaCubeEntity(EntityType<? extends MagmaCubeEntity> type, World world) {
		super(type, world);
	}
}
