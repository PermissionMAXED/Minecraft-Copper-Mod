 ...
 * {@code loot_table/entities/slag_silverfish.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class SlagSilverfishEntity extends SilverfishEntity {
	public SlagSilverfishEntity(EntityType<? extends SilverfishEntity> type, World world) {
		super(type, world);
	}
