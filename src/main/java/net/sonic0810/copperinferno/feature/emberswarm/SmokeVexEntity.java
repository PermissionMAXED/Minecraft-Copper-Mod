 ...
 * {@code loot_table/entities/smoke_vex.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class SmokeVexEntity extends VexEntity {
	public SmokeVexEntity(EntityType<? extends VexEntity> type, World world) {
		super(type, world);
	}
}
