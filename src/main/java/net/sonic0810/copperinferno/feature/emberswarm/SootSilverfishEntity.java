 ...
 * {@code loot_table/entities/soot_silverfish.json}.
 * Generated by {@code devtools/gen/emberswarm_gen.py}.
 */
public class SootSilverfishEntity extends SilverfishEntity {
	public SootSilverfishEntity(EntityType<? extends SilverfishEntity> type, World world) {
		super(type, world);
	}
