...
public final class InfernoBossFeature {
	...
	private static void registerHandbookEntries() {
		HandbookEntries.add(new HandbookEntry("bosses", "the_oxidizer",
				...
				"The Oxidizer - a giant corroded iron golem. Summon: click an Oxidizer Core on any copper block. It hunts players on sight and every few seconds vents a corrosive verdigris cloud (Slowness + Weakness within 6 blocks); below half health it enrages and speeds up. Drops an Oxidizer Heart and 2-4 Verdigris Scales.",
				"Der Oxidierer - ein riesiger korrodierter Eisengolem. Beschwörung: einen Oxidierer-Kern auf einen beliebigen Kupferblock klicken. Er jagt Spieler auf Sicht und stößt alle paar Sekunden eine ätzende Grünspanwolke aus (Langsamkeit + Schwäche im Umkreis von 6 Blöcken); unter halber Gesundheit wird er rasend und schneller. Lässt ein Oxidierer-Herz und 2-4 Grünspanschuppen fallen."));
