...
/**
 * Emberclad Piglin - a piglin armored in glowing ember shards, native to the Inferno dimension. Behavior is pure
 ...
 * Emberclad Scrap ({@code loot_table/entities/emberclad_piglin.json}).
 *
 * <p>Generated by {@code devtools/gen/slagfiends_gen.py}; do not edit by hand.
 */
public class EmbercladPiglinEntity extends PiglinEntity {
	public EmbercladPiglinEntity(EntityType<? extends AbstractPiglinEntity> type, World world) {
		super(type, world);
	}
