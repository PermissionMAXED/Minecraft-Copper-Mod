...
final class SlagFiendsHandbook {
	...
	static void register() {
		HandbookEntries.add(new HandbookEntry("mobs", "slag_wraith", "copper_inferno:slag_wraith_spawn_egg", null,
				null,
				null, 0, "Slag Wraith - a slag-crusted wither skeleton spirit haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Slagbone Shard.", "Schlackengeist - ein schlackenverkrusteter Witherskelett-Geist, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schlackenknochen-Splitter fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "cinder_reaper", "copper_inferno:cinder_reaper_spawn_egg", null,
				null,
				null, 0, "Cinder Reaper - a swift, scythe-armed skeletal reaper haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Reaper Cinder.", "Aschenschnitter - ein flinker, sensenbewehrter Skelett-Schnitter, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schnitterasche fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ashbone_knight", "copper_inferno:ashbone_knight_spawn_egg", null,
				null,
				null, 0, "Ashbone Knight - an armored skeletal knight of ash-bleached bone haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Ashbone Chip.", "Aschenknochen-Ritter - ein gepanzerter Skelett-Ritter aus aschgebleichtem Knochen, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Aschenknochen-Span fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ember_revenant", "copper_inferno:ember_revenant_spawn_egg", null,
				null,
				null, 0, "Ember Revenant - a smouldering revenant that refuses to stay slain haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Revenant Ember.", "Glutwiederg\u00e4nger - ein schwelender Wiederg\u00e4nger, der sich nicht bezwingen l\u00e4sst, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Wiederg\u00e4nger-Glut fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "sootbone_harrower", "copper_inferno:sootbone_harrower_spawn_egg", null,
				null,
				null, 0, "Sootbone Harrower - a stooped, soot-black harrower of the ashfields haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Harrower Soot.", "Ru\u00dfknochen-Peiniger - ein gebeugter, ru\u00dfschwarzer Peiniger der Aschefelder, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Peinigerru\u00df fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "molten_hoglin", "copper_inferno:molten_hoglin_spawn_egg", null,
				null,
				null, 0, "Molten Hoglin - a hulking hoglin dripping molten slag haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Molten Hoglin Tusk.", "Schmelzhoglin - ein massiger Hoglin, von dem geschmolzene Schlacke trieft, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schmelzhoglin-Hauer fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "cinderhide_boar", "copper_inferno:cinderhide_boar_spawn_egg", null,
				null,
				null, 0, "Cinderhide Boar - a fast, cinder-pelted boar haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Cinderhide Scrap.", "Aschenfell-Keiler - ein schneller Keiler mit Aschenfell, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Aschenfell-Fetzen fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "slagtusk_brute", "copper_inferno:slagtusk_brute_spawn_egg", null,
				null,
				null, 0, "Slagtusk Brute - a slab-shouldered brute with tusks of hardened slag haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Slagtusk Fragment.", "Schlackenhauer-Rohling - ein breitschultriger Rohling mit Hauern aus geh\u00e4rteter Schlacke, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schlackenhauer-Bruchst\u00fcck fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "emberback_hog", "copper_inferno:emberback_hog_spawn_egg", null,
				null,
				null, 0, "Emberback Hog - a hog whose bristled back glows with embers haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Emberback Bristle.", "Glutr\u00fccken-Eber - ein Eber, dessen borstiger R\u00fccken vor Glut gl\u00fcht, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Glutr\u00fccken-Borste fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ashsnout_gorer", "copper_inferno:ashsnout_gorer_spawn_egg", null,
				null,
				null, 0, "Ashsnout Gorer - an ill-tempered gorer with an ash-grey snout haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Ashsnout Hide.", "Aschenschnauzen-Spie\u00dfer - ein reizbarer Spie\u00dfer mit aschgrauer Schnauze, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Aschenschnauzen-Haut fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "cinder_piglin", "copper_inferno:cinder_piglin_spawn_egg", null,
				null,
				null, 0, "Cinder Piglin - a cinder-dusted piglin warrior haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Cinder Tooth.", "Aschenpiglin - ein aschebest\u00e4ubter Piglin-Krieger, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Aschenzahn fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "slagforged_piglin", "copper_inferno:slagforged_piglin_spawn_egg", null,
				null,
				null, 0, "Slagforged Piglin - a piglin clad in crude slag-forged plates haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Slagforged Plate.", "Schlackengeschmiedetes Piglin - ein Piglin in grob schlackengeschmiedeten Platten, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schlackengeschmiedete Platte fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "emberclad_piglin", "copper_inferno:emberclad_piglin_spawn_egg", null,
				null,
				null, 0, "Emberclad Piglin - a piglin armored in glowing ember shards haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Emberclad Scrap.", "Glutgepanzertes Piglin - ein in gl\u00fchende Glutsplitter gepanzertes Piglin, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Glutpanzer-Fetzen fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ashen_piglin_marauder", "copper_inferno:ashen_piglin_marauder_spawn_egg", null,
				null,
				null, 0, "Ashen Piglin Marauder - a hard-hitting marauder scouring the ashfields for loot haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Marauder Tusk.", "Aschen-Piglin-Marodeur - ein hart zuschlagender Marodeur auf Beutezug durch die Aschefelder, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Marodeurshauer fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "soot_piglin_plunderer", "copper_inferno:soot_piglin_plunderer_spawn_egg", null,
				null,
				null, 0, "Soot Piglin Plunderer - a quick soot-smeared plunderer haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Plunderer Soot.", "Ru\u00df-Piglin-Pl\u00fcnderer - ein flinker, ru\u00dfverschmierter Pl\u00fcnderer, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Pl\u00fcnderer-Ru\u00df fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ember_stalker", "copper_inferno:ember_stalker_spawn_egg", null,
				null,
				null, 0, "Ember Stalker - a tall stalker wreathed in drifting embers haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Stalker Pearl.", "Glutpirscher - ein hochgewachsener Pirscher, umweht von treibender Glut, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Pirscherperle fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "cinder_shade", "copper_inferno:cinder_shade_spawn_egg", null,
				null,
				null, 0, "Cinder Shade - a flickering shade of cinder and smoke haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Shade Essence.", "Aschenschatten - ein flackernder Schatten aus Asche und Rauch, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schattenessenz fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "slagveil_lurker", "copper_inferno:slagveil_lurker_spawn_egg", null,
				null,
				null, 0, "Slagveil Lurker - a lurker hidden behind a shimmering veil of slag haze haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Lurker Veil.", "Schlackenschleier-Lauerer - ein Lauerer, verborgen hinter einem flimmernden Schleier aus Schlackendunst, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Lauererschleier fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ashgaze_warper", "copper_inferno:ashgaze_warper_spawn_egg", null,
				null,
				null, 0, "Ashgaze Warper - a warper whose ash-grey gaze bends space haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Warper Iris.", "Aschenblick-Wandler - ein Wandler, dessen aschgrauer Blick den Raum kr\u00fcmmt, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Wandleriris fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "sootflare_haunt", "copper_inferno:sootflare_haunt_spawn_egg", null,
				null,
				null, 0, "Sootflare Haunt - a haunt trailing sparks of burning soot haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Haunt Flare.", "Ru\u00dfflammen-Spuk - ein Spuk, der Funken brennenden Ru\u00dfes hinter sich herzieht, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Spukleuchte fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "ashen_zombie_piglin", "copper_inferno:ashen_zombie_piglin_spawn_egg", null,
				null,
				null, 0, "Ashen Zombie Piglin - a zombified piglin bleached grey by falling ash haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Charred Flesh.", "Aschen-Zombiepiglin - ein zombifiziertes Piglin, grau gebleicht vom Aschefall, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Verkohltes Fleisch fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "slagrot_piglin", "copper_inferno:slagrot_piglin_spawn_egg", null,
				null,
				null, 0, "Slagrot Piglin - a rotting piglin fused with cooling slag haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Slagrot Chunk.", "Schlackenmoder-Piglin - ein moderndes Piglin, verwachsen mit erkaltender Schlacke, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Schlackenmoder-Brocken fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "emberflesh_piglin", "copper_inferno:emberflesh_piglin_spawn_egg", null,
				null,
				null, 0, "Emberflesh Piglin - a piglin whose dead flesh smoulders from within haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Emberflesh Strip.", "Glutfleisch-Piglin - ein Piglin, dessen totes Fleisch von innen schwelt, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Glutfleisch-Streifen fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "cinderbound_piglin", "copper_inferno:cinderbound_piglin_spawn_egg", null,
				null,
				null, 0, "Cinderbound Piglin - a shackled piglin bound in cinder-caked irons haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Cinderbound Shackle.", "Aschengebundenes Piglin - ein gefesseltes Piglin in ascheverkrusteten Eisen, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Aschenfessel fallen."));

		HandbookEntries.add(new HandbookEntry("mobs", "sootrot_marauder", "copper_inferno:sootrot_marauder_spawn_egg", null,
				null,
				null, 0, "Sootrot Marauder - a hulking undead marauder caked in wet soot haunting the Cinder Wastes, Ember Grove and Slag Sea. Hostile. Drops Sootrot Hide.", "Ru\u00dfmoder-Marodeur - ein massiger untoter Marodeur, verklebt mit nassem Ru\u00df, heimisch in der Aschen\u00f6de, im Gluthain und im Schlackenmeer. Feindselig. L\u00e4sst Ru\u00dfmoder-Haut fallen."));
		...
		HandbookEntries.add(new HandbookEntry("items", "inferno_powder_from_reaper_cinder", "copper_inferno:reaper_cinder", "slagfiends/inferno_powder_from_reaper_cinder",
				...
				"copper_inferno:inferno_powder", 2, "Craft 2x Inferno Powder from Reaper Cinder + Copper Dust at a crafting table.", "Stellt 2x Infernopulver aus Schnitterasche + Kupferstaub an der Werkbank her."));
		...
		HandbookEntries.add(new HandbookEntry("items", "leather_from_cinderhide_scrap", "copper_inferno:cinderhide_scrap", "slagfiends/leather_from_cinderhide_scrap",
				...
				"minecraft:leather", 1, "Craft 1x Leather from Cinderhide Scrap + Cinderhide Scrap at a crafting table.", "Stellt 1x Leder aus Aschenfell-Fetzen + Aschenfell-Fetzen an der Werkbank her."));
		...
		HandbookEntries.add(new HandbookEntry("items", "bone_meal_from_cinder_tooth", "copper_inferno:cinder_tooth", "slagfiends/bone_meal_from_cinder_tooth",
				...
				"minecraft:bone_meal", 2, "Craft 2x Bone Meal from Cinder Tooth at a crafting table.", "Stellt 2x Knochenmehl aus Aschenzahn an der Werkbank her."));
		...
		HandbookEntries.add(new HandbookEntry("items", "iron_nugget_from_cinderbound_shackle", "copper_inferno:cinderbound_shackle", "slagfiends/iron_nugget_from_cinderbound_shackle",
				...
				"minecraft:iron_nugget", 4, "Craft 4x Iron Nugget from Cinderbound Shackle at a crafting table.", "Stellt 4x Eisenklumpen aus Aschenfessel an der Werkbank her."));
