...
/**
 * Slagforged Piglin - a piglin clad in crude slag-forged plates, native to the Inferno dimension. Behavior is pure
 ...
 * Slagforged Plate ({@code loot_table/entities/slagforged_piglin.json}).
 *
 * <p>Generated by {@code devtools/gen/slagfiends_gen.py}; do not edit by hand.
 */
public class SlagforgedPiglinEntity extends PiglinEntity {
	public SlagforgedPiglinEntity(EntityType<? extends AbstractPiglinEntity> type, World world) {
		super(type, world);
	}
