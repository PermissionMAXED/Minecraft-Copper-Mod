 ...
 * {@code setOnFireForTicks(60)}). Tameable like any wolf. {@code createChild} is overridden
 * only for type consistency (vanilla hard-codes {@code EntityType.WOLF}; same fix as the
 * infernomobs Cinder Strider). Drops Pepper Spice
...
public class PepperPupEntity extends WolfEntity {
	...
	@Override
	public PepperPupEntity createChild(ServerWorld world, PassiveEntity entity) {
		return new PepperPupEntity(SodaFaunaFeature.PEPPER_PUP, world);
	}
}
